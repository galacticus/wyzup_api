...
router.post('/food-ingredients', async (req, res) => {
    try {
...
router.get('/food-ingredients', async (req, res) => {
    try {
...
router.get('/food-ingredients/:food_id', async (req, res) => {
    try {
...
router.delete('/food-ingredients/:food_id/:ingredient_id', async (req, res) => {
    try {
